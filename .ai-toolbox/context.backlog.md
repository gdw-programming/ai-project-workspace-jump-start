...
**Active criteria**: Age out completed items after 30 days OR keep only 3 newest per contributor, whichever comes first
...
| Priority | Item | Depends On | Parallel Safe? |
|----------|------|------------|----------------|
